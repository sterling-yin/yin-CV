...
长期专注于先进建筑结构与材料**冲击动力学**研究，在工程材料领域的*Cem. Concr. Compos.*、*Cem. Concr. Res.*，结构工程领域的*Compos. Struct.*、*Eng. Struct.*，力学领域的*Int. J. Mech. Sci.*、*Int. J. Solids. Struct.*、*Eng. Fract. Mech.*，冲击动力学领域的*Int. J. Impact Eng.*等期刊发表高水平SCI论文16篇，其中2篇曾入选ESI高被引论文。
                  """)
...
st.write(
    """
    - ⭐ Postdoctoral Fellow, 2023.10-, College of Civil Engineering and Architecture, ***Zhejiang University*** (Supervisor: Prof. Qinghua Li) | 博士后，2023.10-，浙江大学建筑工程学院，合作导师为国家杰青李庆华教授 
    - ⭐ PhD, 2017.9-2023.9, Structural Engineering, ***Zhejiang University***, Hangzhou, China (Supervisor: Academician Prof. Shilang Xu) | 博士研究生，2017.9-2023.99，浙江大学结构工程专业，导师为中国科学院院士徐世烺教授
    - ⭐ BEng, 2013.8-2017.6, Civil Engineering, ***Ocean University of China***, Qingdao, China | 本科，2013.8-2017.6，中国海洋大学土木工程专业
"""
)
