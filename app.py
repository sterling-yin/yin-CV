...
tab1, tab2, tab3, tab4, tab5 = st.tabs(["🌟 Introduction", "🎖️ Featured Publications", "📑 Complete Publications List", "🏛️ Academic Lineage", "🗄️ Codes"])
