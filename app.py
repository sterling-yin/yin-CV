...
银星，1995年9月出生于内蒙古自治区包头市。长期专注于先进建筑结构与材料**冲击动力学**研究，在工程材料领域的Cem. Concr. Compos.(4)、Cem. Concr. Res.(1)，结构工程领域的Compos. Struct.(1)、Eng. Struct.(1)，力学领域的Int. J. Mech. Sci.(1)、Int. J. Solids Struct.(1)、Eng. Fract. Mech.(3)、Int. J. Impact Eng.(1)等期刊发表高水平SCI论文16篇，其中2篇曾入选ESI高被引论文。    
""")
