...
*Cem. Concr. Res.*(1), *Compos. Struct.*(1), *Eng. Struct.*(1), *Int. J. Impact Eng.*(2), *Int. J. Mech. Sci.*(1), *Eng. Fract. Mech.*(3), 
...
结构工程领域的*Compos. Struct.*(1)、*Eng. Struct.*(1)，固体力学领域的*Int. J. Mech. Sci.*(1)、*Int. J. Solids Struct.*(1)，
